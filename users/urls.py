...
urlpatterns = [
    ...
    path('profile/update/partial/', views.update_partial_profile, name='update_partial_profile'),
    ...
    path('app/profile/update/partial/', frontend_views.app_profile_update_partial, name='app_profile_update_partial'),
